...
public class AlipayConfig {
    ...
    //支付宝分配给开发者的应用ID
    //@Value("${alipay.appId}")
    public  String appId = "2019080866140472";
