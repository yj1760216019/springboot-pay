...
import com.calinx.pay.unionpay.sdk.SDKConstants;
...
public class UnionPayConfig {
	...
	//支付地址
	public static String requestAppUrl = SDKConfig.getConfig().getAppRequestUrl();

	//退货地址
	public static String backRequestUrl = SDKConfig.getConfig().getBackRequestUrl();

	//退货回调地址
	public static String refundBackUrl = SDKConfig.getConfig().getRefundBackUrl();
